...
public class DashboardManager {
  ...
  private final String getColorForAlliance(Alliance alliance) {
  ...
  private final String getAllianceColorForShift(Alliance autoWinner, int shift) {
    ...
    if (shift % 2 == 0) {
      ...
      Alliance alliance = switch (autoWinner) {
